      ...
      <div className="mx-auto max-w-6xl px-6 md:px-8">
        ...
        <MotionWrapper>
          <p className="mb-12 max-w-2xl text-lg leading-relaxed text-muted-foreground md:text-xl">
            From industrial automation on the plant floor to embedded systems and PCB design in the
            lab, I bring hands-on electronics experience to every project I take on.
          </p>
        </MotionWrapper>
        <div>
